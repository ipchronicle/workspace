...
- [0053: Model public addresses as probe subjects (partially superseded by 0059)](0053-model-public-addresses-as-probe-subjects.md)
...
- [0059: Scope automatic address-change probing to nodes](0059-scope-address-change-probing-to-nodes.md)
