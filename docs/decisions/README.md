...
- [0007: Use one-command automatic Agent registration (partially superseded by 0074)](0007-one-command-agent-registration.md)
...
- [0010: Separate SQLite configuration and history databases (partially superseded by 0073)](0010-separate-sqlite-databases.md)
